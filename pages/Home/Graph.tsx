						...
						<View style={styles.viewWrapper}>
							<View style={styles.modalView}>
								...
								<View style={{...theme.backgroundwhite, marginTop:h(3), marginBottom:h(3)}}>
									<QRCode content={status.walletAddress} codeStyle='square' outerEyeStyle='square' innerEyeStyle='square' size={180} backgroundColor="white" logo={qricon.icicb}  logoSize = {40} />
								</View>
